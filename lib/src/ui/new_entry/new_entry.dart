...
import 'package:mad/src/common/convert_time.dart';
import 'package:mad/src/global_bloc.dart';
import 'package:mad/src/models/errors.dart';
import 'package:mad/src/models/medicine.dart';
import 'package:mad/src/models/medicine_type.dart';
import 'package:mad/src/ui/homepage/homepage.dart';
import 'package:mad/src/ui/new_entry/new_entry_bloc.dart';
import 'package:mad/src/ui/success_screen/success_screen.dart';
      ...
      child: Container(
        child: Row(
          ...
          children: <Widget>[
            ...
            DropdownButton<int>(
              iconEnabledColor: Color(0xFF00E2E2),
              hint: _selected == 0
                  ? Text(
                      "Select an Interval",
                      style: TextStyle(
        ...
        children: <Widget>[
          Container(
            ...
            decoration: BoxDecoration(
              ...
              color: isSelected ? Color(0xFF00E2E2) : Colors.white,
            ),
            child: Center(
              child: Padding(
                ...
                child: Icon(
                  ...
                  size: 75,
                  color: isSelected ? Colors.white : Color(0xFF00E2E2),
                ),
              ),
            ),
          ),
          Padding(
            ...
            child: Container(
              ...
              height: 30,
              decoration: BoxDecoration(
                color: isSelected ? Color(0xFF00E2E2) : Colors.transparent,
    ...
    return Padding(
      ...
      child: Text.rich(
        TextSpan(children: <TextSpan>[
          ...
          TextSpan(
            text: isRequired ? " *" : "",
            style: TextStyle(fontSize: 14, color: Color(0xFF00E2E2)),
          ),
        ]),
      ),
    );
