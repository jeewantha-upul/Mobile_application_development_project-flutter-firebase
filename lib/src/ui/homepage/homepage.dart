...
import 'package:mad/src/ui/medicine_details/medicine_details.dart';
import 'package:mad/src/ui/new_entry/new_entry.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Color(0xFF00E2E2),
        elevation: 0.0,
      ),
      body: Container(
